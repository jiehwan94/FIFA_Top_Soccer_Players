...
## \webshot4b06e557fa1.png": 지정된 파일을 찾을 수 없습니다
```

```
## Warning in file(con, "rb"): cannot open file 'C:\Users\SCSC\AppData\Local
## \Temp\RtmpGq6j3D\file4b06f3d43e6\webshot4b06e557fa1.png': No such file or
## directory
```
...
아쉽게도 각 선수의 포지션은 나와 있지 않습니다. gk필드의 값을 이용해 골키퍼는 구분할 수 있을지 몰라도.. 아니면 predictive analytics를 이용해 각 선수의 포지션을 예측할 수 있는 모델을 만들 수도 있을 것 같네요.
...
마우커서를 올려놓았을 때, 선수이름을 순차적으로 나타내고 싶었는데 잘 안되네요..
